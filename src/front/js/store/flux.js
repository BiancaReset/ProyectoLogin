const getState = ({ getStore, getActions, setStore }) => {
	return {
	  store: {
		url: "https://miniature-invention-6j4rrrj6r6xh4jjw-3001.app.github.dev/",
	  ...
	  actions: {
		...
		getMessage: async () => {
		  try {
			...
			const resp = await fetch("https://miniature-invention-6j4rrrj6r6xh4jjw-3001.app.github.dev/hello", options);
